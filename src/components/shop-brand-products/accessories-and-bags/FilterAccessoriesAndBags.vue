            ...
            <main class="mx-auto max-w-full px-4 sm:px-6 lg:px-8">
                <div class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-12">
                    <p>1 - 2 pages over 32 items for <span class="text-blue-700 font-semibold tracking-tight underline">A
                            Never-Ending Sunglasses Season</span>
                    </p>
...
import AccessoriesAndBags from './AccessoriesAndBags.vue';
import AccessoriesAndBagsProducts from './AccessoriesAndBagsProducts.vue';
