        ...
        <div>
            ...
            <main class="mx-auto max-w-full px-4 sm:px-6 lg:px-8">
                <div class="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-12">
                    <p>1 - 10 pages over 223 items for <span
                            class="text-blue-700 font-semibold tracking-tight underline">Active-wear For Your
                            Coolness</span>
                    </p>
...
import ActiveWear from './ActiveWear.vue';
import ActiveWearProducts from './ActiveWearProducts.vue';
