<template>
    <div class="mx-auto max-w-full py-6 sm:px-6 lg:px-8">
        <section class="container m-10 mx-auto max-w-full sm:px-6 lg:px-8">
            <h2 class="text mb-6">Express Deals</h2>
    ...
    <div class="mx-auto max-w-full py-6 sm:px-6 lg:px-8">
        <section class="container m-10 mx-auto max-w-full sm:px-6 lg:px-8">
            <h2 class="text mb-6">Global Deals</h2>
            <Carousel v-bind="settings" :breakpoints="breakpoints" :wrapAround="true" :transition="500" :autoplay="3000">
...
import { useWomenGlobalDealsStore } from '@/stores/categories/womenGlobalDealsStore'
import { useWomenExpressDealsStore } from '@/stores/categories/womenExpressDealsStore'
import { Carousel, Slide, Navigation } from 'vue3-carousel'
import 'vue3-carousel/dist/carousel.css'

const store = useWomenGlobalDealsStore()
const storeTwo = useWomenExpressDealsStore()
