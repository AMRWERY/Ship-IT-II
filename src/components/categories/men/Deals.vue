...
import { useMenGlobalDealsStore } from '@/stores/categories/menGlobalDealsStore'
import { useMenExpressDealsStore } from '@/stores/categories/menExpressDealsStore'
import { Carousel, Slide, Navigation } from 'vue3-carousel'
import 'vue3-carousel/dist/carousel.css'

const store = useMenGlobalDealsStore()
const storeTwo = useMenExpressDealsStore()
