<template>
    <div class="mx-auto max-w-5xl py-6 sm:px-6 lg:px-8">
        <section class="container m-10 mx-auto max-w-full sm:px-6 lg:px-8">
            <h2 class="text-center text-3xl font-semibold mb-10">Shop by Brand</h2>
    ...
    <div class="grid gap-4 md:gap-8 justify-center grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
        <div class="relative md:aspect-w-4 md:aspect-h-2 aspect-w-3 aspect-h-2">
            <img src="https://justfields.com/storage/projects/7M5rV059/express-deals-men.gif" class="rounded-lg shadow"
                loading="lazy">
        </div>
        <div class="relative md:aspect-w-4 md:aspect-h-2 aspect-w-3 aspect-h-2">
            <img src="https://justfields.com/storage/projects/7M5rV059/global-deals-men.gif" class="rounded-lg shadow"
                loading="lazy">
        </div>
    </div>
</template>
