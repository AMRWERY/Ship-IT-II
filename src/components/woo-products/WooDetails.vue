                ...
                <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                    ...
                    <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-200 mb-5">
                        <div class="flex">
                            ...
                            <button
                                class="border-2 border-gray-300ml-1 bg-gray-700 rounded-full w-6 h-6 focus:outline-none"></button>
                            <button
                    ...
                    <div class="flex">
                        <span class="title-font font-medium text-2xl text-gray-900">EGP58.00</span>
                        <button
                            class="flex ml-auto text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded-lg">
                            Buy now
                        </button>
                    </div>
                </div>
