...
export const useShopByBrandStore = defineStore("shop-by-brand", {
  state: () => {
    return {
      images: [],
      files: [],
  ...
  actions: {
    ...
    async uploadImg(file) {
      ...
      const storagePath = "/Shop by Brand/" + file.name;
