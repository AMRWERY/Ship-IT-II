<template>
  <div class="grid my-16 px-4 bg-white place-content-center">
    <div class="text-center">
      <img src="/error404.svg" class="w-auto h-56 mx-auto text-black sm:h-64">

      <h1 class="mt-6 text-2xl font-bold tracking-tight text-gray-900 sm:text-4xl">
        Uh-oh!
      </h1>

      <p class="mt-4 text-gray-500 text-lg">We can't find that page.</p>
